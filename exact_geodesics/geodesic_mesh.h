...
public:
	...
	void initialize_mesh_data(unsigned num_vertices,
							  Points const& p,
							  unsigned num_faces,
							  Faces const& tri);		//build mesh from regular point-triangle representation

	template<class Points, class Faces>
	void initialize_mesh_data(Points const& p, Faces const& tri);		//build mesh from regular point-triangle representation
...
template<class Points, class Faces>
void Mesh::initialize_mesh_data(Points const& p, Faces const& tri)		//build mesh from regular point-triangle representation
{
	assert(p.size() % 3 == 0);
