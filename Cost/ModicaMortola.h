...
struct HierarchicalRegularization {

    explicit HierarchicalRegularization(Mesh& mesh);
    ...
    [[nodiscard]] static FunctionalType::Value type() { return FunctionalType::HierarchicalRegularization; }
...
DECLARE_FUNCTIONAL_CONSTRUCTOR(HierarchicalRegularization)
...
DECLARE_FUNCTIONAL_OPERATOR(HierarchicalRegularization, double)
...
DECLARE_FUNCTIONAL_OPERATOR(HierarchicalRegularization, adouble)
#endif
